...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
	...
	*/
	private int [] mDrawables = new int [4];
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        if (iconResId != 0) {
            mDrawables [location] = iconResId;
            tabView.setCompoundDrawablesWithIntrinsicBounds(mDrawables[0], mDrawables[1], mDrawables[2], mDrawables[3]);
            
            if (this.location == LOCATION_UP) {
...
//        }
    ...
    public void setTabIconLocation (int newLocation){
        ...
        for (int x = 0; x < mDrawables.length;x++){
            mDrawables [x] = NO_ICON;
        }
    }
